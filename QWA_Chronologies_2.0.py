...
Workdir1="/Users/julieedwards/Documents/Projects/MANCHA/QWA/Data/Nov2023QWA" #individual image output
Workdir2="/Users/julieedwards/Documents/Projects/MANCHA/QWAData/Nov2023QWA/concat/"  #concatenated output
Workdir3="/Users/julieedwards/Documents/Projects/MANCHA/QWAData/Nov2023QWA/concat/Summary/" # summary output
Workdir4="/Users/julieedwards/Documents/Projects/MANCHA/QWAChronologies/" #final chronologies
yrstart="1000"
yrend="2022"
method="q75" #  # 4 options: "mean","median","q25","q75"   #different methods for aggregation within each intra-ring band  
resolution="20,80" #spatial resolution of profiles (micrometers), i.e. width of intra-ring bands
Series= "MRW","MXDCWA","MXCWTRAD","MXCWTTAN","EWW","MLA.EW","LWW" #Cell series of interest to use in chronology making

SECTORAGGREGATE="TRUE"   #SLOW, when this option is activated, intra-ring sector profiles are calculated and saved to file
...
for filename in SeriesFiles:
  ...
  filled=df.interpolate(method='cubicspline',limit_area='inside')
